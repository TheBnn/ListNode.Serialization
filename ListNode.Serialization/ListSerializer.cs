...
namespace ListNode.Serialization
{
    internal sealed class ListSerializer : IListSerializer
    {
        ...
        /// <returns></returns>
        async Task ISerializable.Serialize(ListNode head, Stream stream)
        {
        ...
        /// <param name="stream"></param>
        /// <returns></returns>
        async Task<ListNode> IDeserializable.Deserialize(Stream stream)
        {
            ListNode head = null;
        ...
        /// <param name="head"></param>
        /// <returns></returns>
        Task<ListNode> IDeepCopy.DeepCopy(ListNode head)
        {
            var node = head;
            ListNode tail = null;
            ListNode copy = null;
